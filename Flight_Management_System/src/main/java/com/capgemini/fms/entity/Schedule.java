...
public class Schedule {
	...
	//@GeneratedValue(strategy = GenerationType.SEQUENCE,generator ="schedule_id")
	//@SequenceGenerator(sequenceName="schedule_id", initialValue=1,allocationSize=1, name="schedule_id")
